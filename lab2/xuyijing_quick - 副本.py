...
for m in range(4):
    ...
    for i in range(0, len(OPTIONDATA[m])):
        ...
        for k in range(1, 500):
            if F1COST[OPTIONDATA[m][i]][k] < ast.literal_eval(COST[m])*100+1 and F1STABILITY[OPTIONDATA[m][i]][k] > ast.literal_eval(STABILITY[m]) and fc[OPTIONDATA[m][i]] > F1COST[OPTIONDATA[m][i]][k] and fs[OPTIONDATA[m][i]] < F1STABILITY[OPTIONDATA[m][i]][k]:
                fc[OPTIONDATA[m][i]] = F1COST[OPTIONDATA[m][i]][k]
                fs[OPTIONDATA[m][i]] = F1STABILITY[OPTIONDATA[m][i]][k]
    for i in range(0, len(OPTIONDATA[m])):
        for k in range(0, 500):
            if F1COST[OPTIONDATA[m][i]][k] < ast.literal_eval(COST[m])*100+1 and F1STABILITY[OPTIONDATA[m][i]][k] > ast.literal_eval(STABILITY[m]) and not(fc[OPTIONDATA[m][i]] < F1COST[OPTIONDATA[m][i]][k] and fs[OPTIONDATA[m][i]] > F1STABILITY[OPTIONDATA[m][i]][k]):
